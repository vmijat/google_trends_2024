...
ggsave(file.path("plots", "gtrends_de_2024_dark.png"), device = ragg::agg_png,
       dpi = 300, width = 6, height = 7.5)
...
ggsave(file.path("plots", "gtrends_de_2024_light.png"), device = ragg::agg_png,
       dpi = 300, width = 6, height = 7.5)
